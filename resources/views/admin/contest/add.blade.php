...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Add Contest Details</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="{{route('contests')}}">Contests</a></li>
                        <li class="breadcrumb-item active"><a href="{{route('contest.add')}}">Add</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8">
                    <div class="card">
                        <form action="{{route('contest.create')}}" method="post" id="contestForm" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="contestTitle">Contest Title</label>
                                    <input type="text" name="title" class="form-control" id="contestTitle" placeholder="Enter Title">
                                </div>
                                <div class="form-group">
