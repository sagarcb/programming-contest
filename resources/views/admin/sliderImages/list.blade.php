...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Image Slider Images</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="{{route('sliderImages')}}">Image Slider</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Image Slider List</h3>
                        </div>
                        <div class="card-body">
                            <table id="noticesTable" class="table table-bordered table-hover">
                                ...
                                @foreach($sliderImages as $slider)
                                    <tr>
                                        <td>{{$slider->id}}</td>
                                        <td>
                                            <img src="{{Storage::url($slider->image)}}" style="width: 80px" alt="">
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <form action="{{route('sliderImage.delete', $slider->id)}}"
