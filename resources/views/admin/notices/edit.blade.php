            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('notice.edit', $notice->id)}}">Edit</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <form action="{{route('notice.edit', $notice->id)}}" method="post" id="noticeForm">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="noticeTitle">Notice Title</label>
                                    <input type="text" name="title" class="form-control" id="noticeTitle" placeholder="Enter Title" value="{{$notice->title}}">
                                </div>
                                <div class="form-group">
                                    <label for="noticeDescription">Notice Description</label>
                                    <textarea id="noticeDescription" name="description">{{$notice->description}}</textarea>
